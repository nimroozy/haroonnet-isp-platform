...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-t+71v*w_k66*8o_l!6y^ic(=2$!!^yhib=go+wp!y8(^49--15')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'isp_management'),
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@isp-management.com')
